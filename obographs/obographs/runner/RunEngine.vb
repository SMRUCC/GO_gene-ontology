...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		...
		Public Overridable Function loadOWL(ByVal iri As org.semanticweb.owlapi.model.IRI) As org.semanticweb.owlapi.model.OWLOntology
		...
		''' <returns> OWL Ontology </returns>
		''' <exception cref="OWLOntologyCreationException"> </exception>
		Public Overridable Function loadOWL(ByVal file As java.io.File) As org.semanticweb.owlapi.model.OWLOntology
